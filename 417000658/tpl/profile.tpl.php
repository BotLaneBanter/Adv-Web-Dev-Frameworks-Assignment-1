...
<html lang="en-GB">
	...
	<body>
		<nav>
			...
			<ul>
				<li><a href="profile.php?controller=Courses">Courses</a></li>
				<li><a href="profile.php?controller=Streams">Streams</a></li>
				<li><a href="profile.php?controller=AboutUs">About Us</a></li>
				<?php 
				if(isset($_SESSION)){
					echo "<li><a href='profile.php?controller=Logout'>Logout</a></li>";
				}
				else{
